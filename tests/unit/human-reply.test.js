...
test("human replies are idempotent and unknown provider delivery cannot auto-retry", async () => {
  ...
  const context = { module: { exports: {} }, require(name) { if (name === "path") return path; if (name === "./safeWrite") return safeWrite; if (name === "./customers") return { saveTurn: async () => {} }; throw new Error(name); }, Date, JSON, String, RegExp, Object };
